...
destination_dir = r"C:\Aishwarya PROJECTS 6\PHONEPE PROJECT\DATA"
...
agg_path = r"C:/second/pulse-master/pulse-master/data/aggregated/transaction/country/india/state/"
...
engine = create_engine('mysql+mysqlconnector://root:Dreamer_1@localhost/Phonepe', echo=False)
Agg_Trans.to_sql('agg_trans', con=engine, if_exists='replace', index=False)
engine.dispose()

# path of concerned file
map_path = r"C:/second/pulse-master/pulse-master/data/map/transaction/hover/country/india/state/"
...
# path of concerned file
top_path = r"C:/second/pulse-master/pulse-master/data/top/transaction/country/india/state/"
...
# path of concerned file
top_path_user = r"C:/second/pulse-master/pulse-master/data/top/user/country/india/state/"
...
# creating a list of columns for specific dataframe
clm = {'State': [], 'Year': [], 'Quarter': [], 'Brand': [], 'Users_Count': [], 'User_Percentage': [],
       'Registered_Users': [], 'AppOpen': []}

# path of concerned file
agg_path_user = r"C:/second/pulse-master/pulse-master/data/aggregated/user/country/india/state/"
...
# path of concerned file
map_path_user = r"C:/second/pulse-master/pulse-master/data/map/user/hover/country/india/state/"
...
comb_df = pd.concat(
    [Agg_Trans, Map_Trans, Top_Trans_dist, Top_Trans_pin, Top_user_pin, Top_user_dis, agg_user, map_user])
...
if nav == 'HOME':
    ...
    if year == 2023 and quarter == 4:
        ...
        with tab1:  # when switched for 1st Tab
            ...
            Trans_val_state.append(
                fin_list[0][5] if len(fin_list) != 0 else 0)  # returns total amount accounted on finance
            ...
            with col41:  # with first half section
                category = ['Recharge & Bill Payments', 'Peer to Peer Payments', 'Merchant Payments',
                            'Financial Services',
                            'Others']  # list of title
                cols = ['#4C8BE2', '#00e061', '#fe073a', '#e1bc3a',
                        '#4e8e71']  # list of color code for pie visualization
        ...
        with tab3:  # when switched for 3rd Tab
            ...
            pincode_user_list = pincode_user_df[
                'Pincode'].tolist()  # returns a list of pincode where user data available
        ...
        with tab4:  # when switched for 4th Tab
            ...
            for ii in state_list:
                ...
                type_trans_val.append(
                    type_trans_list[0][5] if len(
                        type_trans_list) != 0 else 0)  # returns a list of typewise trans amount
    ...
    st.markdown("#### Aishwarya Medhe_")
    st.markdown("### Linked In")
    st.info("www.linkedin.com/in/aishwarya-medhe-a328bb286")
